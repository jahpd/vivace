...
(function() {
  var apply, confLastVoices, lastvoices, loadcode, run, voices;

  voices = window.Vivace.voices;

  lastvoices = window.Vivace.lastvoices;

  apply = function(text, callback) {
    var activeVoices, currentVoices;
    currentVoices = null;
    activeVoices = null;
    return Vivace.exec('vivace_lang', text, function(exec_voices) {
